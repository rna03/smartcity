...
[ApiController]
[Route("api/fire-stations")]
public sealed class FireStationsController(ISpatialDataQueryService queryService) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<ActionResult<IReadOnlyList<PointFeatureDto>>> Get(
        ...
        Ok(await queryService.GetFireStationsAsync(cancellationToken));
}
