...
export const translations = Object.freeze({
  en: Object.freeze({
    ...
    loadingDashboard: "Loading dashboard summary...",
    ...
    selectedLocationOutsidePilotArea: "The selected location is outside the pilot analysis area. Please select a location within the pilot area.",
    latitude: "Latitude",
    longitude: "Longitude",
    ...
    previewingPriority: "Calculating priority...",
    calculatingPriorityScore: "Calculating the incident priority score...",
    priority: "Priority",
    priorityScore: "Priority Score",
    priorityLevel: "Priority Level",
    priorityBreakdown: "Priority Breakdown",
    incidentTypeScore: "Incident Type Score",
    serviceDistanceScore: "Service Distance Score",
    ...
    medium: "Medium",
    high: "High",
    prioritySummary: "Priority: {level} ({score}/100)",
  ...
  tr: Object.freeze({
    ...
    latestIncidents: "Son Olaylar",
    incidentDistribution: "Olay Dağılımı",
    priorityCounts: "Öncelik Sayıları",
    noIncidentsYet: "Henüz olay kaydı yok",
    loadingDashboard: "Genel bakış özeti yükleniyor...",
    ...
    selectedLocationOutsidePilotArea: "Seçilen konum pilot analiz alanının dışındadır. Lütfen pilot bölge içerisinden bir konum seçin.",
    latitude: "Enlem",
    longitude: "Boylam",
    ...
    previewPriority: "Önceliği Hesapla",
    previewingPriority: "Öncelik hesaplanıyor...",
    calculatingPriorityScore: "Olay öncelik skoru hesaplanıyor...",
    priority: "Öncelik",
    priorityScore: "Öncelik Skoru",
    priorityLevel: "Öncelik Düzeyi",
    priorityBreakdown: "Öncelik Bileşenleri",
    incidentTypeScore: "Olay Türü Puanı",
    serviceDistanceScore: "Hizmet Mesafesi Puanı",
    accessibilityPenalty: "Erişilebilirlik Cezası",
    relevantService: "İlgili Acil Hizmet",
    hospital: "Hastane",
    fireStation: "İtfaiye İstasyonu",
    low: "Düşük",
    medium: "Orta",
    high: "Yüksek",
    prioritySummary: "Öncelik: {level} ({score}/100)",
